...
id_array=(
    "w2tm5r46 0am807pj hjgnm8rh vd0yg6lb bvm4zsko"
    "2rg0gwsz wbovv3bq 2ov1oq2b 2y6tz6xm ypy4sllk"
...
eval_datasets=(AUMC Hirid EICU) #(AUMC MIMIC Hirid EICU Physionet2019) #MIMIC_LOCF
eval_datasets2=(aumc hirid eicu) #(aumc mimic hirid eicu physionet2019) #sklearn formatting  (physionet2019) #
