...
concepts <- list(
    ...
    , list("alb",         NA_character_,      readr::col_double())
    , list("alt",         NA_character_,      readr::col_double())
    , list("basos",       NA_character_,      readr::col_double())
    , list("bnd",         NA_character_,      readr::col_double())
    , list("cai",         NA_character_,      readr::col_double())
    , list("ck",          NA_character_,      readr::col_double())
    , list("ckmb",        NA_character_,      readr::col_double())
    , list("crp",         NA_character_,      readr::col_double())
    , list("eos",         NA_character_,      readr::col_double())
    , list("esr",         NA_character_,      readr::col_double())
    , list("hbco",        NA_character_,      readr::col_double())
    , list("inr_pt",      NA_character_,      readr::col_double())
    , list("lymph",       NA_character_,      readr::col_double())
    , list("mch",         NA_character_,      readr::col_double())
    , list("mchc",        NA_character_,      readr::col_double())
    , list("mcv",         NA_character_,      readr::col_double())
    , list("methb",       NA_character_,      readr::col_double())
    , list("na",          NA_character_,      readr::col_double())
    , list("neut",        NA_character_,      readr::col_double())
    , list("po2",         NA_character_,      readr::col_double())
    , list("pt",          NA_character_,      readr::col_double())
    , list("rbc",         NA_character_,      readr::col_double())
    , list("rdw",         NA_character_,      readr::col_double())
    , list("tco2",        NA_character_,      readr::col_double())
    , list("tnt",         NA_character_,      readr::col_double())
    , list("abx",         NA_character_,      readr::col_logical())
    , list("ins",         NA_character_,      readr::col_double())
    , list("weight",      NA_character_,      readr::col_double())
    , list("height",      NA_character_,      readr::col_double())
    , list("vaso_ind",    NA_character_,      readr::col_logical())
    , list("vent_ind",    NA_character_,      readr::col_logical())
    , list("gcs",         NA_character_,      readr::col_integer())
    , list("rass",        NA_character_,      readr::col_double())
    , list("urine24",     NA_character_,      readr::col_double())
    , list("sofa_resp",   NA_character_,      readr::col_integer())
    , list("sofa_coag",   NA_character_,      readr::col_integer())
    , list("sofa_liver",  NA_character_,      readr::col_integer())
    , list("sofa_cardio", NA_character_,      readr::col_integer())
    , list("sofa_cns",    NA_character_,      readr::col_integer())
    , list("sofa_renal",  NA_character_,      readr::col_integer())
    , list("sofa",        NA_character_,      readr::col_integer())
    , list("qsofa",       NA_character_,      readr::col_integer())
    , list("sirs",        NA_character_,      readr::col_integer())
    , list("news",        NA_character_,      readr::col_integer())
    , list("mews",        NA_character_,      readr::col_integer())
)
