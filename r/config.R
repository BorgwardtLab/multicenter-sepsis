...
concepts <- list(
    ...
    , list("abx", NA_character_, NULL)
    , list("ins", NA_character_, NULL)
    , list("weight", NA_character_, NULL)
    , list("height", NA_character_, NULL)
    , list("vaso_ind", NA_character_, NULL)
    , list("vent_ind", NA_character_, NULL)
    , list("gcs", NA_character_, NULL)
    , list("rass", NA_character_, NULL)
    , list("urine24", NA_character_, NULL)
    , list("sofa_resp", NA_character_, NULL)
    , list("sofa_coag", NA_character_, NULL)
    , list("sofa_liver", NA_character_, NULL)
