...
python -m src.sklearn.main --method lr  --result_path $result_path --cv_n_jobs=20 --n_iter_search=50 --dataset=hirid --task classification --feature_set $feature_set --cost=$cost
#python -m src.sklearn.main --method lr  --result_path $result_path --cv_n_jobs=7 --n_iter_search=50 --dataset=eicu --task classification --feature_set $feature_set --cost=$cost
