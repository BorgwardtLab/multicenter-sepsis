...
python -m src.sklearn.main --result_path $result_path --cv_n_jobs=1 --n_iter_search=20 --dataset=aumc --extended_features
...
python -m src.sklearn.main  --method lr --result_path $result_path --cv_n_jobs=1 --n_iter_search=20 --dataset=physionet2019 --extended_features --feature_set=challenge
...
python -m src.sklearn.main  --method=lr --result_path $result_path --cv_n_jobs=1  --n_iter_search=20 --dataset aumc --extended_features
